package alliwannadev.shop.support.dataserializer;
...
class DataSerializerTest {
    ...
    @DisplayName("[SUPPORT] JSON 문자열을 역직렬화하는 경우")
    @Test
    ...
    @DisplayName("[SUPPORT] 특정 객체를 역직렬화하는 경우")
    @Test
    ...
    @DisplayName("[SUPPORT] 특정 객체를 직렬화하는 경우")
    @Test
