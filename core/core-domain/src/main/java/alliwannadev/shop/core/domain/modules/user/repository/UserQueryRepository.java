...
import alliwannadev.shop.core.domain.modules.user.repository.dto.QGetUserDto;
...
import static alliwannadev.shop.core.domain.modules.user.domain.QUser.user;
